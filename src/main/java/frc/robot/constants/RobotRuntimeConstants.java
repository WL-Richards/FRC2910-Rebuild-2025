...
import frc.robot.config.base.RobotID;

/**
 * Constants that are determined to drive the overall state of the code.
 * Examples of such may include current runtime mode, which bot is actively in use
 */
public final class RobotRuntimeConstants {
