...
public class CANDeviceID {
    ...
    */
    ...
    public CANDeviceID(int canID, String deviceName, CANDeviceType deviceType, String busName){
    ...
    public CANDeviceID(int canID, String deviceName, CANDeviceType deviceType) {
