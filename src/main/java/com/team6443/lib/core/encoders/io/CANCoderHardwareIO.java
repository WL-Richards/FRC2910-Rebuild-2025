...
package com.team6443.lib.core.encoders.io;
...
import com.team6443.lib.core.encoders.factories.CANCoderFactory;
...
*/
public class CANCoderHardwareIO implements CANCoderIO, CANable {
    ...
    public CANCoderHardwareIO(CANCoderConfiguration config){
        this.config = config;
