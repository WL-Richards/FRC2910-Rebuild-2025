...
public interface Loggable {
     ...
     * @param standardPrefix What comes before this file in the Log path, this should end with a / 
     * @param inputPrefix What comes before this file in the Log path used for logging inputs, this should end with a / 
     */
