...
import com.team6443.lib.constants.generated.BuildConstants;

import edu.wpi.first.wpilibj.DriverStation;
import edu.wpi.first.wpilibj.RobotBase;

/** 
 * Interface for how the object responsible for logging the data should look
*/
public interface Loggerable {
    ...
    public default void updateMetadata(){
        ...
        Logger.recordMetadata("RobotName", RobotRuntimeConstants.kRobotIdentification.getName());
        Logger.recordMetadata("MACAddress", RobotRuntimeConstants.kRobotIdentification.getMACAddress());
    };
}
